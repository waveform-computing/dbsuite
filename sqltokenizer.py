...
class SQLTokenizerBase(object):
	...
	def __init__(self):
		...
		self.keywords = set(sqldialects.sql92_keywords)
		self.identchars = set(sqldialects.sql92_identchars)
		self.spacechars = ' \t\r\n'
...
class SQL99Tokenizer(SQLTokenizerBase):
	...
	def __init__(self):
		...
		self.keywords = set(sqldialects.sql99_keywords)
		self.identchars = set(sqldialects.sql99_identchars)
...
class SQL2003Tokenizer(SQLTokenizerBase):
	...
	def __init__(self):
		...
		self.keywords = set(sqldialects.sql2003_keywords)
		self.identchars = set(sqldialects.sql2003_identchars)
...
class DB2ZOSSQLTokenizer(SQLTokenizerBase):
	...
	def __init__(self):
		...
		self.keywords = set(sqldialects.ibmdb2zos_keywords)
		self.identchars = set(sqldialects.ibmdb2zos_identchars)
...
class DB2UDBSQLTokenizer(DB2ZOSSQLTokenizer):
	...
	def __init__(self):
		...
		self.keywords = set(sqldialects.ibmdb2udb_keywords)
		self.identchars = set(sqldialects.ibmdb2udb_identchars)
