...
class Field(RelationObject):
	...
	def __getPrototype(self):
		...
		if self.generated == 'Always':
			items.append('GENERATED ALWAYS %s' % (self.generateExpression))
		elif self.generated == 'By Default':
			items.append('GENERATED BY DEFAULT %s' % (self.generateExpression))
		return ' '.join(items)
